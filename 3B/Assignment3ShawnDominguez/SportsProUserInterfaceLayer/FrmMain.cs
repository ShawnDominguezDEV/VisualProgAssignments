...
namespace SportsProUserInterfaceLayer
{
    public partial class FrmMain : Form
    {
        ...
        FrmOpenIncidentsByTechnician aFormViewOpenIncidents = new FrmOpenIncidentsByTechnician();
        FrmAddRegistration aFormAddRegistration = new FrmAddRegistration();
        ...
        private void displayOpenIncidentsByTechToolStripMenuItem_Click(object sender, EventArgs e)
        {
            showFormInMDI(aFormViewOpenIncidents);
        }

        private void addRegistrationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            showFormInMDI(aFormAddRegistration);
        }
    }
}
